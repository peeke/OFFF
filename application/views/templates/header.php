...
<div id="header">
    <div class="logo"></div>
    <a href="<?=site_url('start/large_logo_button')?>" class="button offf"></a>
...
<div id="mobile-menu" class="mobile-only large-text">
    <ul>
        ...
        <li><a href="<?=site_url('page/ranking')?>" class="">Klassement</a></li><?php } ?>
        <?php if ($this->session->userdata('logged_in')) { ?><li><a href="<?=site_url('user/logout')?>" class="">Uitloggen</a></li>
        <?php } else { ?><li><a href="<?=site_url('user/login')?>">Inloggen</a></li>
        <li><a href="<?=site_url('user/register')?>">Registreren</a></li><?php } ?>
    </ul>
    <p>&nbsp;</p>
    <ul>
...
<div class="clear"></div>
<p class="mobile-only">
    <a href="#" class="toggle-mobile-menu icon dots-blue" style="margin-left: 15px;">&nbsp; Menu</a>
    <?php if ($this->session->userdata('logged_in')) { ?><a href="<?=site_url('user/logout')?>" class="pull-right" style="margin-right: 25px;">Uitloggen</a>
    <?php } else { ?><a href="<?=site_url('user/login')?>"  class="pull-right" style="margin-right: 25px;">Inloggen</a><?php } ?>
</p>